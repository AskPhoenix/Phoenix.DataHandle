...
namespace Phoenix.DataHandle.Migrations
{
    ...
    [Migration("20220410005344_V3_alpha3")]
    partial class V3_alpha3
    {
            ...
            modelBuilder.Entity("BroadcastCourse", b =>
                {
                    ...
                    b.HasIndex(new[] { "CourseId" }, "IX_BroadcastCourses_CourseId");
            ...
            modelBuilder.Entity("CourseBook", b =>
                {
                    ...
                    b.HasIndex(new[] { "BookId" }, "IX_CourseBooks_BookId");
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.AspNetUser", b =>
                {
                    ...
                    b.Property<int>("DependenceOrder")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "PhoneCountryCode", "PhoneNumber", "DependenceOrder" }, "IX_AspNetUsers_CountryCode_PhoneNumber_DependenceOrder")
                        .IsUnique();

                    b.HasIndex(new[] { "NormalizedUserName" }, "UQ_AspNetUsers_NormalizedUserName")
                        .IsUnique();
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.Exercise", b =>
                {
                    ...
                    b.HasIndex(new[] { "BookId" }, "IX_Exercises_BookId");
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.Lecture", b =>
                {
                    ...
                    b.HasIndex(new[] { "ClassroomId" }, "IX_Lectures_ClassroomId");

                    b.HasIndex(new[] { "CourseId", "ScheduleId" }, "IX_Lectures_Course_Schedule");

                    b.HasIndex(new[] { "ScheduleId" }, "IX_Lectures_ScheduleId");
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.Material", b =>
                {
                    ...
                    b.HasIndex(new[] { "BookId" }, "IX_Materials_BookId");
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.Schedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "ClassroomId" }, "IX_Schedules_ClassroomId");
            ...
            modelBuilder.Entity("Phoenix.DataHandle.Main.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("IdentifierCodeExpiresAt")
                        .HasColumnType("datetime");
